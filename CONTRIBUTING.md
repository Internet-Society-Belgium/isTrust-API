...
Please create an [issue](https://github.com/Internet-Society-Belgium/isTrust-API/issues/new/choose).
...
Go to the [repository](https://github.com/Internet-Society-Belgium/isTrust-API) and fork it with your GitHub account.

#### 2. Clone your fork on your local machine

```bash
git clone https://github.com/<YOUR_USERNAME>/isTrust-API.git
```
